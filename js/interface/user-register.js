...
import { closeLoginModal } from "../controllers/login-modal";

export function apiRequest_userRegister(fullName,email, password) {

    let jsonRequest = {};
    jsonRequest.full_name = fullName;
    jsonRequest.email = email;
    jsonRequest.password = password;

    axios.post('../API/user-register.php', jsonRequest)
